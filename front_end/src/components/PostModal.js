          ...
          <div className="modalBody"> 
            ...
            <ol>
              ...
              <div style={{display:"flex", justifyContent: "space-between"}}>
                <div className="modal-img"><img className="modal-img" src={'http://http://ec2-3-38-107-72.ap-northeast-2.compute.amazonaws.com' + modal.cm_image} onError={handleImgError} width="190px" height="190px"></img></div>

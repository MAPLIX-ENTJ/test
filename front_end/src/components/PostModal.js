          ...
          <div className="modalBody"> 
            ...
            <ol>
              ...
              <div style={{display:"flex", justifyContent: "space-between"}}>
                <div className="modal-img"><img className="modal-img" src={'http://ec2-3-37-76-88.ap-northeast-2.compute.amazonaws.com:8000' + modal.cm_image} onError={handleImgError} width="190px" height="190px"></img></div>

...
export default function WriteStamp({card, openModal}) {
  ...
  const loadPost = async () => {
    const response = await axios.post('http://http://ec2-3-38-107-72.ap-northeast-2.compute.amazonaws.com:8000/api/stampcheck'
    , {id, m_num, poster}
    );
  ...
  useEffect(()=> {
    ...
    const handleSubmit = (e) => {
      ...
      if (img.file == null) {
        ...
        axios.post("http://http://ec2-3-38-107-72.ap-northeast-2.compute.amazonaws.com:8000/api/writestamp", formData, config)
        .then((response) => {
          if (part == 1) {
    ...
    const clickPoster1 = (e) => {
      ...
      if (record1 != true) {
        ...
        const res = axios.post("http://http://ec2-3-38-107-72.ap-northeast-2.compute.amazonaws.com:8000/api/stampcheck", {
          id,
          m_num,
          poster,
          part
    ...
    <div>
      ...
      <div className={styles2.stamp_modal}>
        ...
        <div className={styles.form_container}>
          ...
          <img  className={styles2.sm_img} src={'http://http://ec2-3-38-107-72.ap-northeast-2.compute.amazonaws.com:8000' + record_image}></img>
          <div className={styles.write_item}>
            {/* <label htmlFor='record_title'>제목</label> */}

...
function SearchPage () {
  ...
  const loadData = () => {
    if ( searchCate === "title"){
      axios.get('http://http://ec2-3-38-107-72.ap-northeast-2.compute.amazonaws.com/api/search/title', {
        params: {
            'media': search
        }
      ...
      axios.get('http://http://ec2-3-38-107-72.ap-northeast-2.compute.amazonaws.com/api/search/area', {
        params: {
            'media': search
        }
      }).then(function (response) {
...
//     let response;
//     if ( searchCate === "title"){
//       response = await axios.get('http://http://ec2-3-38-107-72.ap-northeast-2.compute.amazonaws.com/api/search/title', {
//         params: {
//             'media': search
//         }
//       });
//     } else if ( searchCate === "area"){
//       response = await axios.get('http://http://ec2-3-38-107-72.ap-northeast-2.compute.amazonaws.com/api/search/area', {
//         params: {
//             'media': search
//         }
//       });

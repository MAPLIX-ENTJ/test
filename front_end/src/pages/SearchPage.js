...
function SearchPage () {
  ...
  const loadData = () => {
    if ( searchCate === "title"){
      axios.get('http://ec2-3-37-76-88.ap-northeast-2.compute.amazonaws.com:8000/api/search/title', {
        params: {
            'media': search
        }
      ...
      axios.get('http://ec2-3-37-76-88.ap-northeast-2.compute.amazonaws.com:8000/api/search/area', {
        params: {
            'media': search
        }
      }).then(function (response) {
...
//     let response;
//     if ( searchCate === "title"){
//       response = await axios.get('http://ec2-3-37-76-88.ap-northeast-2.compute.amazonaws.com:8000/api/search/title', {
//         params: {
//             'media': search
//         }
//       });
//     } else if ( searchCate === "area"){
//       response = await axios.get('http://ec2-3-37-76-88.ap-northeast-2.compute.amazonaws.com:8000/api/search/area', {
//         params: {
//             'media': search
//         }
//       });

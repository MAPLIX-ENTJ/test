...
const Login = () =>  {
    ...
    const onClickLogin = (e) => {
        ...
        fetch("http://ec2-3-38-107-72.ap-northeast-2.compute.amazonaws.com/api/login", {
            method: "POST",
            headers: {
        ...
        .then(res => res.json())
            .then(json => {
                ...
                if(json.tf === false){      // json을 받아왔는데 .tf 값이 true면 사용가능
                    ...
                    // const res = axios.post("http://ec2-3-38-107-72.ap-northeast-2.compute.amazonaws.com/", {id,pw})
                    // .then((res) => {
                        alert("로그인 성공")

...
const SignUp = () => {
  ...
  const idCheck = (e) => {
    ...
    fetch("http://ec2-3-37-76-88.ap-northeast-2.compute.amazonaws.com:8000/api/checkid", {
        method: "POST",
        headers: {
  ...
  const nicknameCheck = (e) => {
    ...
    fetch("http://ec2-3-37-76-88.ap-northeast-2.compute.amazonaws.com:8000/api/checknickname", {
        method: "POST",
        headers: {
            "Content-Type" : "application/json"
        },
    ...
    if (!email || !id || !pw || !confirm_pw || !u_name || !birth || !gender || !nick_name) {
      // toast.error("Please provide value into each input field");
        ...
        console.log(email, id, pw, u_name, birth, gender, nick_name);
      const res = axios.post("http://ec2-3-37-76-88.ap-northeast-2.compute.amazonaws.com:8000/api/signup", {
        email,
        id,
        pw,
        confirm_pw,
      ...
      .then((res) => {
        axios.post("http://ec2-3-37-76-88.ap-northeast-2.compute.amazonaws.com:8000/api/poster", {id})

...
const loadData = () => {
  ...
  let nowcate = "";
    ...
    if (Object.values(activeCate)[0].flag === true){ // likelist
        axios.post('http://http://ec2-3-38-107-72.ap-northeast-2.compute.amazonaws.com:8000/api/likelist',{id})
        ...
        // axios.get('http://http://ec2-3-38-107-72.ap-northeast-2.compute.amazonaws.com:8000/api/search')
        axios.get('http://http://ec2-3-38-107-72.ap-northeast-2.compute.amazonaws.com:8000/api/search/title', {params: {
          'media': ''
      }})
        .then(function (response) {
            setCardList(response.data);

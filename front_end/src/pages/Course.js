...
const loadData = () => {
  ...
  let nowcate = "";
    ...
    if (Object.values(activeCate)[0].flag === true){ // likelist
        axios.post('http://ec2-3-37-76-88.ap-northeast-2.compute.amazonaws.com:8000/api/likelist',{id})
        ...
        // axios.get('http://ec2-3-37-76-88.ap-northeast-2.compute.amazonaws.com:8000/api/search')
        axios.get('http://ec2-3-37-76-88.ap-northeast-2.compute.amazonaws.com:8000/api/search/title', {params: {
          'media': ''
      }})
        .then(function (response) {
            setCardList(response.data);

...
const WritePost = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (cm_title == "") {
      ...
      if (img.file == null){
        axios.post("http://ec2-3-37-76-88.ap-northeast-2.compute.amazonaws.com:8000/api/community/writepost", {cm_title, cm_content, writer, cm_type})
        .then((response) => {
        ...
        axios.post("http://ec2-3-37-76-88.ap-northeast-2.compute.amazonaws.com:8000/api/community/writepostimg", formData, config)
        .then((response) => {
          console.log(response);

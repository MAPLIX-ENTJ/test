...
const WritePost = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (cm_title == "") {
      ...
      if (img.file == null){
        axios.post("http://http://ec2-3-38-107-72.ap-northeast-2.compute.amazonaws.com/api/community/writepost", {cm_title, cm_content, writer, cm_type})
        .then((response) => {
        ...
        axios.post("http://http://ec2-3-38-107-72.ap-northeast-2.compute.amazonaws.com/api/community/writepostimg", formData, config)
        .then((response) => {
          console.log(response);
